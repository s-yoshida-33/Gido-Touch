...
// Restores the Gido Touch window to the foreground when another TOPMOST window
// (e.g. a stale RustDesk overlay) steals focus.
// ---------------------------------------------------------------------------
...
fn main() {
    ...
    // Detects when another window steals focus and restores the Gido Touch window
